...
const char* const netplan_backend_to_str[NETPLAN_BACKEND_MAX_] = {
...
static const char* const netplan_def_type_to_str[NETPLAN_DEF_TYPE_MAX_] = {
    [NETPLAN_DEF_TYPE_NONE] = NULL,        [NETPLAN_DEF_TYPE_ETHERNET] = "ethernets",
    [NETPLAN_DEF_TYPE_WIFI] = "wifis",     [NETPLAN_DEF_TYPE_MODEM] = "modems",
    [NETPLAN_DEF_TYPE_BRIDGE] = "bridges", [NETPLAN_DEF_TYPE_BOND] = "bonds",
    [NETPLAN_DEF_TYPE_VLAN] = "vlans",     [NETPLAN_DEF_TYPE_VRF] = "vrfs",
    [NETPLAN_DEF_TYPE_TUNNEL] = "tunnels", [NETPLAN_DEF_TYPE_PORT] = "_ovs-ports",
...
static const char* const netplan_addr_gen_mode_to_str[NETPLAN_ADDRGEN_MAX] = {[NETPLAN_ADDRGEN_DEFAULT] = NULL,
                                                                              [NETPLAN_ADDRGEN_EUI64]   = "eui64",
                                                                              [NETPLAN_ADDRGEN_STABLEPRIVACY] =
                                                                                  "stable-privacy"};

static const char* const netplan_infiniband_mode_to_str[NETPLAN_IB_MODE_MAX_] = {
    [NETPLAN_IB_MODE_KERNEL]    = NULL,
    [NETPLAN_IB_MODE_DATAGRAM]  = "datagram",
    [NETPLAN_IB_MODE_CONNECTED] = "connected"};

#define NAME_FUNCTION(_radical, _type)                                                                                 \
    const char* netplan_##_radical##_name(_type val)                                                                   \
    {                                                                                                                  \
...
#define NAME_FUNCTION_FLAGS(_radical)                                                                                  \
    const char* netplan_##_radical##_name(NetplanFlags val)                                                            \
    {                                                                                                                  \
...
#define ENUM_FUNCTION(_radical, _type)                                                                                 \
    _type netplan_##_radical##_from_name(const char* val)                                                              \
    {                                                                                                                  \
...
NETPLAN_ABI const char* tunnel_mode_to_string(NetplanTunnelMode val) __attribute__((alias("netplan_tunnel_mode_name")));

NETPLAN_ABI extern const char* netplan_backend_to_name __attribute__((alias("netplan_backend_to_str")));
